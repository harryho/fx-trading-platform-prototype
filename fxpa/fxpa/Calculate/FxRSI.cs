...
namespace fxpa
{
    public class FxRSI
    {
        ...
        //private RSI(String code, int interval)
        //{
        //    this.code = code;		
        ...
        //private RSI(String code, int interval, int initSize)
        //{
        //    this.code = code;
        //    this.interval = interval;
        ...
        public double handleFullCandle(BarData candle)
        {
        ...
        protected void OnCalculate(int startingIndex, int indexCount)
        {
